...
public class Service {
    ...
    public ResponseWrapper<?> authorMeeting(String username) {
        ResponseWrapper<?> ret = authorService.authorMeeting(username);
    ...
    public ResponseWrapper<?> getSubmissionList(String authorName, String meetingName) {
        ResponseWrapper<?> ret = authorService.getSubmissionList(authorName, meetingName);
        if (ret.getResponseMessage().equals(ResponseGenerator.success)) {
    ...
    public ResponseWrapper<?> getArticleDetail(String articleId) {
        ...
        return authorService.getArticleDetail(articleId);
    }

    public ResponseWrapper<?> submitNewArticle(ArticleRequest request, String rootDir) {
        ResponseWrapper<?> ret = authorService.uploadNewArticle(request, rootDir);
        if (ret.getResponseMessage().equals(ResponseGenerator.success)) {
    ...
    public ResponseWrapper<?> updateArticle(String articleId, ArticleRequest request, String rootDir) {
        ResponseWrapper<?> ret = authorService.updateExistedArticle(articleId, request, rootDir);
        if (ret.getResponseMessage().equals((ResponseGenerator.success))) {
    ...
    public ResponseWrapper<?> getReviewsOfArticle(String articleId) {
        ResponseWrapper<?> ret = authorService.getAllReviews(articleId);
        if (ret.getResponseMessage().equals(ResponseGenerator.success)) {
    ...
    public Article findArticleById(String articleId) {
        Article ret = articleService.findArticleById(articleId);
        logger.debug("Data access findArticleById " + articleId + " is requested");
        return ret;
    }

    public List<Article> findArticleByIdNot(String articleId) {
        List<Article> ret = articleService.findArticleByIdNot(articleId);
        logger.debug("Data access findArticleByIdNot " + articleId + " is requested");
        return ret;
    }

    public List<Article> findArticleByContributorName(String contributorName) {
        List<Article> ret = articleService.findArticleByContributorName(contributorName);
        logger.debug("Data access findArticleByContributorName " + contributorName + " is requested");

        return ret;
    }

    public List<Article> findArticleByMeetingName(String meetingName) {
        List<Article> ret = articleService.findArticleByMeetingName(meetingName);
        logger.debug("Data access findArticleByMeetingName " + meetingName + " is requested");
        return ret;
    }

    public List<Article> findArticleByMeetingNameAndStatus(String meetingName, String status) {
        List<Article> ret = articleService.findArticleByMeetingNameAndStatus(meetingName, status);
        logger.debug("Data access findArticleByMeetingNameAndStatus " + meetingName + " " + status + " is requested");
        return ret;
    }

    public List<Article> findArticleByContributorNameAndMeetingName(String contributeName, String meetingName) {
        List<Article> ret = articleService.findArticleByContributorNameAndMeetingName(contributeName, meetingName);
        logger.debug("Data access findArticleByContributorNameAndMeetingName " + contributeName + " " + meetingName + " is requested");
        return ret;
    }
