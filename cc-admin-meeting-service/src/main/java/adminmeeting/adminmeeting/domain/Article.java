package adminmeeting.adminmeeting.domain;
...
public class Article {
    ...
    private Set<Pair<adminmeeting.domain.Author,Integer>> authors;

    public Article() {}

    public Article(String contributorName, String meetingName, String submitDate, String title, String articleAbstract, String filePath, String status, Set<String> topic, Set<Pair<adminmeeting.domain.Author, Integer>> authors) {
    ...
    public Set<Pair<adminmeeting.domain.Author, Integer>> getAuthors() {
        return authors;
    }
