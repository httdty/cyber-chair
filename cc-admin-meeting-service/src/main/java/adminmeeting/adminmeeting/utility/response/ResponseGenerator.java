package adminmeeting.adminmeeting.utility.response;
...
public class ResponseGenerator {
    ...
    //处理对象列表生成返回对象
    public static  <T>
    adminmeeting.utility.response.ResponseWrapper<?> injectObjectFromListToResponse(String responsekey, List<T> list, String[] keys, Pair[] keyMapping){
        ...
        return new adminmeeting.utility.response.ResponseWrapper<>(200, ResponseGenerator.success, body);
    }
    ...
    //处理单个实例对象生成返回对象
    public static  <T>
    adminmeeting.utility.response.ResponseWrapper<?> injectObjectFromObjectToResponse(String responsekey, T object, String[] keys, Pair[] keyMapping){
